...
#define WIFI_SSID "iPhone de Mia"    //Fibertel WiFi269 2.4GHz
#define WIFI_PASSWORD "Silvermia18"  //0142901884
...
void loop() {
  ...
  if (millis() - dataMillis <= 120000) {  //Leer solo 2 minutos, 2 lecturas por minuto, osea 1 lectura cada 30s
    valorPote = analogRead(POTE);
    dataMillis = millis();
    if (millis() - dataMillis >= 30000) {
      dataMillis = millis();
      valoresPote[i] = valorPote;
      i++:
    }
  }
